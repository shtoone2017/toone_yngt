...
class NavMenuVC: UIViewController {

    var swiftPagesView : SwiftPages!
    var menu1: SY_NavView!
    var menu2: BH_NavView!
    var page = 0
    ...
    override func viewDidLoad() {
        ...
        menu1 = SY_NavView(frame: CGRect(x: 5, y: 5, width: self.view.frame.width-10, height: self.view.frame.height),nav:self.navigationController!)
        ...
        menu2 = BH_NavView(frame: CGRect(x: self.view.frame.width + 5, y: 5, width: self.view.frame.width-10, height: self.view.frame.height),nav:self.navigationController!)
