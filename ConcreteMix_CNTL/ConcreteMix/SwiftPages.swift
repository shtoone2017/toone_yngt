...
public class SwiftPages: UIView, UIScrollViewDelegate {
    ...
    private var viewControllerIDs: [UIView] = []
    ...
    private var topBarBackground = con.bkcolor
    private var buttonsTextColor = UIColor.blackColor()
    private var containerViewBackground = con.bkcolor
    ...
    override public func drawRect(rect: CGRect)
    {
        ...
        containerView = UIView(frame: CGRectMake(xOrigin, 0, pagesContainerWidth, pagesContainerHeight))
        ...
        if (!buttonsWithImages) {
            for item in buttonTitles
            {
                ...
                if(buttonNumber == 0){
                    barButton.setImage(UIImage(named:"ShiYan"),forState:.Normal)
                }else{
                    barButton.setImage(UIImage(named:"BanHe"),forState:.Normal)
                }
    ...
    public func initializeWithVCIDsArrayAndButtonTitlesArray (VCIDsArray: [UIView], buttonTitlesArray: [String])
    {
    ...
    public func initializeWithVCIDsArrayAndButtonImagesArray (VCIDsArray: [UIView], buttonImagesArray: [UIImage])
    {
    ...
    public func loadPage(page: Int)
    {
        ...
        } else
        {
            ...
            newPageView = viewControllerIDs[page]
    ...
    public func ShowPage()
    {
        ...
        let offsetAddition = (animatedBar.frame.size.width/(CGFloat)(viewControllerIDs.count))*0.8
        animatedBar.frame = CGRectMake(animatedBar.frame.size.width + offsetAddition, animatedBar.frame.origin.y, animatedBar.frame.size.width, animatedBar.frame.size.height);
