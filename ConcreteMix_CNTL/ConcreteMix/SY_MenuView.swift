...
class SY_MenuView: UIView {
    ...
    init(frame: CGRect, nav:UINavigationController, GroupId:String) {
        super.init(frame: frame)
    ...
    func createCircleBtn(){
        ...
        //您的代办事项Label
        let lb_title = UILabel(frame: CGRect(x:btnWidth ,y:0,width:btnWidth,height:40))
        ...
        //按钮
        btn_shiyan = SFlatButton(frame: CGRect(x: 0, y: 30, width: btnWidth01, height: btnWidth01-48),sfButtonType: SFlatButton.SFlatButtonType.SFBLabel)
        ...
        //待处置委托试验Label
        let lb_chuzhi = UILabel(frame: CGRect(x:btnWidth01/4,y:btnWidth01-48-70,width:100,height:60))
        ...
        //按钮
        btn_buhege = SFlatButton(frame: CGRect(x: btnWidth01 + 3, y: 30, width: btnWidth01, height: btnWidth01-48),sfButtonType: SFlatButton.SFlatButtonType.SFBLabel)
        //btn_buhege.backgroundColor = UIColor.grayColor()
        //数字
        ...
        //不合格试验待填报Label
        let lb_tianbao = UILabel(frame: CGRect(x:btnWidth01/4,y:btnWidth01-48-70,width:100,height:60))
        ...
        //线
        let lb_line01 = UILabel(frame: CGRect(x:3,y:150,width:width-3,height:1))
    ...
    func createMenuBtn2(){
        ...
        //按钮宽
        let btnWidth = (width - step * 3) / 2
        let LabelHeight = 200 + btnWidth*2 + 50
        ...
        Alamofire.request(.GET, url + userGroupId + GroupId).responseJSON{ response in
            ...
            if let JSON = response.result.value {
                ...
                if(success == true){
                    ...
                    self.lb_num02.text = (JSON.valueForKey("data"))!.valueForKey("hntkangyacount")! as! String
