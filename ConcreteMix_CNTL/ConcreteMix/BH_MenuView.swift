...
class BH_MenuView: UIView {
    ...
    init(frame: CGRect, nav:UINavigationController, GroupId:String) {
        ...
        uiscrollview.contentSize = CGSize(width: width, height: Int(con.iphone6p_height + 230))
    ...
    func createCircleBtn(){
        ...
        //您的代办事项Label
        let lb_title = UILabel(frame: CGRect(x:width/3 ,y:0,width:width/3,height:40))
        ...
        //按钮
        btn_shiyan = SFlatButton(frame: CGRect(x: 0, y: 30, width: width, height: btnWidth01-48),sfButtonType: SFlatButton.SFlatButtonType.SFBLabel)
        ...
        //线
        let lb_line01 = UILabel(frame: CGRect(x:3,y:90,width:width-3,height:1))
    ...
    func createMenuBtn2(){
        ...
        //按钮宽
        let btnWidth = (width - step * 3) / 2
        let LabelHeight = 200 + btnWidth + 40
