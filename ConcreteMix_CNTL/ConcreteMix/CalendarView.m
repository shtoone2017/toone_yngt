...
- (void)generateMonthRects
{
    ...
    for (NSString *monthName in monthNames) {
        ...
        monthRect.frame = CGRectMake(x, y + 25, self.monthCellWidth, self.monthCellHeight);
...
- (void)generateYearRects
{
    ...
    for (NSNumber *obj in years) {
        ...
        yearRect.frame = CGRectMake(x, y + 25, self.yearCellWidth, self.yearCellHeight);
